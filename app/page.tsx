    ...
    <>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-24 text-center'>
        ...
        <p className='mx-auto mt-6 max-w-2xl text-2xl tracking-tight text-slate-700 dark:text-slate-500'>
          Clean Next.js Starter is a meticulously designed Next.js starter template aimed at providing developers with a clean, efficient, and scalable
          foundation for quickly launching.
        </p>
      </div>
    </>
  )
